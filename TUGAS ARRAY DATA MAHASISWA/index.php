<?php
include('./listdata_mahasiswa.php');
?>
<!DOCTYPE html>
<html lang="en">
...
<main class="container p-3" style="background: 	#E6E6FA;">
  ...
  <section id="soal-3">
    ...
    $cari = infoDiriMahasiswa($arrMahasiswa, 'nrp', '20050974019');
    ...
    if (count($cari)) {
      if (($cari['dataMhs']['kelas'] == 'D4-A' || $cari['dataMhs']['kelas'] == 'D4-B') &&
        ...
        echo $cari['dataMhs']['nama'] . ' merupakan mahasiswa kelas ' . $cari['dataMhs']['kelas'] . ' yang aktif di HIMIT';
      else :
